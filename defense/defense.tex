...
\vspace{10px}
\secagr: \alice computes the isogeny $\pap: E_{\rb} \rightarrow E_{\ba\rb}$ and \bob computes $\pbp$ analogously. The resulting shared secret value is some representation of $E_{\ba\rb}$.
\end{frame}
