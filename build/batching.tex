...
\end{lstlisting}
\vspace{-\baselineskip}
\begin{lstlisting}[backgroundcolor=\color{light-red}, firstnumber=19]
	fp2inv751_mont(jinv);                              // jinv = 1/jinv
\end{lstlisting}
\vspace{-\baselineskip}
\begin{lstlisting}[backgroundcolor=\color{light-green}, firstnumber=20]
...
operations, and then converting back to affine coordinates. 
