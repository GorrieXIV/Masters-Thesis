...
\begin{tikzpicture}
	...
	%\draw (2.5,4.5) node[block] {\code{sign\_thread}};
	\draw [decorate,decoration={brace,amplitude=9pt},xshift=-4pt,yshift=0pt] (4,3) -- (4,5.5) node [black,midway,xshift=-0.6cm,block] {\code{sign\_thread}};
	\draw (6.5,4) node[blockgreen] {\code{j\_inv\_batch}};
	\draw (6.5,5) node[blockgreen] {\code{inv\_4\_way\_batch}};
	\draw (0.7, 4.5) node {1};
	\draw[very thick, loosely dotted] (2,3.7) -- (2,2.2) node {};
	%\draw (2.5,1.5) node[block] {\code{sign\_thread}};
	%\draw [decorate,decoration={brace,amplitude=9pt},xshift=-4pt,yshift=0pt] (0.5,1) -- (0.5,5.0) node [black,midway,xshift=-0.6cm,block] {\code{sign\_thread}};
	\draw (6.5,1) node[blockgreen] {\code{j\_inv\_batch}};
	\draw (6.5,2) node[blockgreen] {\code{inv\_4\_way\_batch}};
	\draw (0.7, 1.5) node {248};
