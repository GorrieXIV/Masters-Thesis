...
This technique can be thought of as analogous to a time/space trade-off. The difference being that, while in standard time/space trade-off algorithms we can sort of ``exchange" The inclusion of this auxilliary variable $a$ allows us to avoid costly inversions at the price of a constant amount of memory. 

We can extend this time/space trade-off further still. Consider the following. 
