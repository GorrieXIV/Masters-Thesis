...
\begin{tikzpicture}[scale=.9]
	\begin{scope}[xshift=-3cm]
		...
		\end{axis}
    \draw (4, -1) node {batch size};
    \draw (-1, 3) node[rotate=90] {millions of clock cycles};
	\end{scope}
...
\end{adjustwidth}
\end{center}
\caption{The projected run-time of \textbf{PartialBatchedInv} (red), \textbf{PartialBatchedInv}$_0$ (blue), and unbatched inversions (yellow) scaling with the number of elements in the batch.}
\end{figure}
