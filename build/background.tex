...
\begin{itemize}
\item \emph{Closure}: Because elliptics curves are polynomials of degree of 3, we know any given line passing through two points $P$ and $Q$ of $E$ will pass through exactly 3 points on $E$. The exceptions here are 1. when $P = Q$ and thus our line is tangent to $E$ and 2. when $Q = -P$ and our line is parallel with the y-axis. We resolve case 1. nicely by definig $P + P$ by means of taking the line tangent to $E$ at point $P$. In case 2, $P + (-P)$ should yield the identity element of the group. We will define this element and resolve this issue below.  
