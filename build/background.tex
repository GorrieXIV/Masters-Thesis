...
\end{figure}
And so our group consists of $(E,+)$. This group operation is referred to as \emph{pointwise addition}. Additionally, we shorthand $n$-many applications of the group operation of a point $P$ to itself as $[n]P$, analogous to scalar multiplication. 
