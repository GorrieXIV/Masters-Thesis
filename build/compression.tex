...
Recall from Section \ref{subsec:sidhkex} the structure of an SIDH public key, $pk$
$$
pk = (E, P, Q)
$$
...
E : y^2 = x^3 + Ax + B
$$
$A$ sufficiently represents $E$ in this context because in \sidh we are concerned only with curves where $B$ = 0. $P$ and $Q$, on the other hand, can each be represented by their $x$-coordinate (two $\mathbb{F}_{p}$ elements) and a single bit determining the correct $y$-coordinate.
